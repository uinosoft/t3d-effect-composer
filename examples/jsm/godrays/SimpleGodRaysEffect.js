...
const radialBlurShader = {
	...
	fragmentShader: `
        ...
        vec4 godrays(float density, float weight, vec2 screenSpaceLightPos) {
            ...
            for(int i = 0; i < SAMPLES; i++) {
                ...
                vec4 samp = texture2D(tDiffuse, textCoo);
                samp *= weight;
                fragColor += samp;
            }
        ...
        void main() {
            ...
            vec4 fragColor = godrays(density, weight, screenSpacePosition);
...
const blendShader = {
	...
	fragmentShader: `
        ...
        void main() {
			...
			color.rgb = srcTexel.rgb * srcTexel.a + dstTexel.rgb * dstTexel.a;
			color.a = srcTexel.a;
